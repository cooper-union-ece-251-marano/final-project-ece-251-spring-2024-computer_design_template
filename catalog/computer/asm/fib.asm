main:
    addi $t1, $zero, 0       # Initialize $at (assembler temporary) to 0 (Fibonacci(0))
    ...
    addi $t3, $zero, 8       # Initialize $a1 (argument) to 8 (target Fibonacci index)
...
finish:
    ...
    lw   $s3, 0($zero)       # Store the 8th Fibonacci number in memory address 0
